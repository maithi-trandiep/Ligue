    ...
    <body>
    	...
    	<section class="presentation">
    		<p>
    			...
    			Pour ajouter ou modifier une prestation, cliquez sur "Prestation"<br>
                Pour ajouter ou modifier une ligue, cliquez sur "Ligue"<br>
                Pour ajouter ou modifier un trésorier, cliquez sur "Trésorier"<br>
                Pour créer ou retrouver une facture, cliquez sur "Facture"
    		</p>
    	</section>
    	<footer class="Bas">
    		<p>
